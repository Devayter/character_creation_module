...
def defence(char_name: str, char_class: str) -> str:
    ...
    выбранного типа персонажа и возвращает строковое сообщение о
    выполненном блокировании атаки."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не защищается')
